class PizzaDelivery:
    ...
    def make_order(self) -> str:
        self.ordered = True
        ingredients_data = ", ".join(f'{k}: {v}' for k, v in self.ingredients.items())
        return f"You've ordered pizza {self.name} prepared with {ingredients_data} and the price will be {self.price}lv."
